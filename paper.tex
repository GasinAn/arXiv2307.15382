...
\begin{equation}
    f(r)=e^{(p/2)r}[C_+e^{i\sqrt{k-(p/2)^2}r}+C_-e^{-i\sqrt{k-(p/2)^2}r}],
\end{equation}
where $C_+$ and $C_-$ are two constants, and
\begin{equation}
    f(r,t)=e^{(p/2)r}[C_+e^{i(+\sqrt{(\omega/c)-(p/2)^2}r-\omega t)}+C_-e^{i(-\sqrt{(\omega/c)-(p/2)^2}r-\omega t)}],
\end{equation}
...
\begin{equation}
    f(r,t)=e^{\int(p/2)\d r}[C_+e^{i(+\int\sqrt{(\omega/c)-(p/2)^2}\d r-\omega t)}+C_-e^{i(-\int\sqrt{(\omega/c)-(p/2)^2}\d r-\omega t)}].
\end{equation}
\end{document}
